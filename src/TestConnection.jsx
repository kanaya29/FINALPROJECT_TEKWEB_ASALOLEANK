...
const TestConnection = () => {
  ...
  const handleTestLogin = () => {
    // Data akun UAD yang sudah kamu buat di Firebase Console
    ...
    signInWithEmailAndPassword(auth, email, password)
      ...
      .catch((error) => {
        // Ini akan membantu kita melihat alasan spesifik kegagalan di console
  ...
  return (
    <div className="p-5 border rounded-lg bg-white shadow-md my-4 mx-auto max-w-md">
      ...
      <div className="p-3 bg-gray-50 rounded border mb-4">
        <p className="text-sm">Status: <span className="font-semibold text-red-600">{status}</span></p>
      </div>
      <button 
